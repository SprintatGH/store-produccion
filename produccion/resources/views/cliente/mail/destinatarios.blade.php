...
@section('content')
   ...
   @if ($action == "listado") 
				...
				<ol class="breadcrumb float-xl-right">
					...
					<h1 class="page-header">Parámetros <small>Destinatarios</small></h1>
					<div class="row">
						<div class="col-xl-12">
							...
							@csrf
							 ...
							 <div class="form-group row m-b-15">
									...
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="text" id="edit_nombre" name="edit_nombre"  data-parsley-required="true" />
									</div>
								</div>

                                <div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="edit_email">Email:</label>
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="text" id="edit_email" name="edit_email"  data-parsley-required="true" />
									</div>
								</div>
	...
	<div class="modal fade" id="modal-add">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="{{ route('CA_mail_desti.store') }}" class="form-horizontal" data-parsley-validate="true">
							@csrf
