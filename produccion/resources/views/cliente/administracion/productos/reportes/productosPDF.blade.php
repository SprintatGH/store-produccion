							...
							<tr>
								...
								<td class="td-60" >
									<div class="pdf-content-from ">
										...
										<strong class="text-inverse">Reporte de Productos</strong><br />
						...
						<table class="table table-pdf">
							<thead>
								<tr>
									...
									<!-- <th style='font-size: 9px;'class="titulo-producto-cente "> </th> -->
								...
								@foreach ($contenido as $items)
									<tr>
										...
										<!-- @if (isset($items->avatar))
											<td ><img src="{{asset('/files/productos/'.$items->avatar)}}"  alt="Logo" height="30px" /></td>
										@else
											<td ><img src="{{asset('/files/productos/sin_imagen.png')}}" alt="Logo" height="30px"/></td>
										@endif -->
                                        <td style='font-size: 9px;' class="text-inverse">{{ $items->nombre }}</td> 
                                        <td style='font-size: 9px;' class="text-center">{{ $items->formatoNombre }}</td>
                                        <td style='font-size: 9px;' class="text-center">{{ $items->precio_unitario }}</td>
                                        <td style='font-size: 9px;' class="text-center">{{ $items->precio_por_mayor }}</td>
                                        <td style='font-size: 9px;' class="text-right">{{ $items->nombre_subcategoria }}</td>
                                        <td style='font-size: 9px;' class="text-right">{{ $items->nombre_categoria }}</td>
