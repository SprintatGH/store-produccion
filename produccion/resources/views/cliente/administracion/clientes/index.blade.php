   ...
   @if ($action == "listado") 
	...
	<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="{{ route('CA_clientes.update') }}" class="form-horizontal" data-parsley-validate="true">
							@csrf
							 	...
							 	<div class="form-group row m-b-15">
									...
									<div class="col-md-8 col-sm-8">
										<select class="form-control" name="tipo_cliente" >
											@foreach ($cm_tipo_cliente as $items)
	...
	<div class="modal fade" id="modal-add">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="{{ route('CA_clientes.store') }}" class="form-horizontal" data-parsley-validate="true">
							@csrf
	...
	<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="{{ route('CA_clientes.precioEspecial') }}" class="form-horizontal" data-parsley-validate="true">
							@csrf
...
<script>
	...
	function getDataClientes(){
		...
		var route = "{{ url('/cliente/administracion/DTclientes') }}";
		var idioma_espaniol = {
...
var precio_especial= function(id)
{
	...
	var route =("{{url('/cliente/administracion/clientes')}}/"+id+"/productos");
	$.get(route, function(data){
				$("#id_cliente").val(id);
