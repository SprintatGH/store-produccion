...
@section('content')
   ...
   @if ($action == "listado") 
				...
				<ol class="breadcrumb float-xl-right">
						...
						<li class="breadcrumb-item active">Cotización Estado</li>
					</ol>
					<h1 class="page-header">Listado <small>Cotización Estado</small></h1>
					<div class="row">
						<div class="col-xl-12">
											...
											<tbody>
												@foreach ($contenido as $items)
													<tr>
														...
														<td class="with-btn" >
															@if ($items->estado==1)
															<a href="#" onclick="cambioEstado(this)" id="In" data-href="{{route('CA_productos_categoria.estado',[ $items->id ,0])  }}"> <span  class="btn btn-sm btn-white m-b-10"><i class="fa fa-trash t-plus-1 text-success fa-fw fa-lg"></i></span></a>
															@else
															<a href="#" onclick="cambioEstado(this)" id="In" data-href="{{route('CA_productos_categoria.estado',[ $items->id ,1])  }}"> <span class="badge bg-success">Ac</span></a>
															@endif
														</td>
	...
	<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="{{ route('CA_productos_categoria.update') }}" class="form-horizontal" data-parsley-validate="true">
							@csrf
	...
	<div class="modal fade" id="modal-add">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="{{ route('CA_productos_categoria.store') }}" class="form-horizontal" data-parsley-validate="true">
							@csrf
...
{
    var route = "{{url('/cliente/administracion/productos/categoria')}}/"+id+"/edit";
