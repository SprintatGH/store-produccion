...
@section('title', 'Materia Prima - Clientes')
	...
	<div class="modal fade" id="modal-add">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="{{ route('CA_ClientesMP.store') }}" class="form-horizontal" data-parsley-validate="true">
							@csrf
...
<script>
        ...
        function getDataClientes(){
            ...
            var route = "{{ url('/cliente/materiaPrima/DTclientes') }}";
            var idioma_espaniol = {
