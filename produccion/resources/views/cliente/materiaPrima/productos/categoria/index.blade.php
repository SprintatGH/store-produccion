	...
	<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="{{ route('CA_productos_categoriaMP.update') }}" class="form-horizontal" data-parsley-validate="true">
							@csrf
	...
	<div class="modal fade" id="modal-add">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="{{ route('CA_productos_categoriaMP.store') }}" class="form-horizontal" data-parsley-validate="true">
							@csrf
...
function getDataProductos(){
    ...
    var route = "{{ url('/cliente/materiaPrima/productos/DTcategoria') }}";
    var idioma_espaniol = {
...
{
    var route = "{{url('/cliente/materiaPrima/productos/categoria')}}/"+id+"/edit";
