	...
	<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="{{ route('CA_productos_formatoMP.update') }}" class="form-horizontal" data-parsley-validate="true">
							@csrf
	...
	<div class="modal fade" id="modal-add">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="{{ route('CA_productos_formatoMP.store') }}" class="form-horizontal" data-parsley-validate="true">
							@csrf
...
function getDataProductos(){
    ...
    var route = "{{ url('/cliente/materiaPrima/productos/DTformato') }}";
    var idioma_espaniol = {
...
{
    var route = "{{url('/cliente/materiaPrima/productos/formato')}}/"+id+"/edit";
