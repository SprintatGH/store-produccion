   ...
   @if ($action == "listado") 
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="{{ route('CA_productosMP.reporte_pdf') }}" class="form-horizontal" data-parsley-validate="true">
							@csrf
	...
	<div class="modal fade" id="modal-stock">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="{{ route('CA_productosMP.store_stock') }}" class="form-horizontal" data-parsley-validate="true">
							@csrf 
	...
	<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="{{ route('CA_productosMP.update') }}" class="form-horizontal" data-parsley-validate="true" enctype="multipart/form-data">
							@csrf
	...
	<div class="modal fade" id="modal-add">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="{{ route('CA_productosMP.store') }}" class="form-horizontal" data-parsley-validate="true" enctype="multipart/form-data">
							@csrf
							@method('POST')
							    <div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="tipo_cliente">Subcategoria :</label>
									...
									<div class="col-md-8 col-sm-8">
  										@if (count($formatos) > 0) 
											...
											@foreach ($formatos as $items)
												<div class="custom-control custom-radio">
													<input type="radio" id="nuevoFormato{{ $items->id }}" name="nuevoFormato" value="{{ $items->nombre}}" class="custom-control-input" >
													<label class="custom-control-label" for="nuevoFormato{{ $items->id }}">{{ $items->nombre}}</label>
												</div>
...
<script>
  ...
  $(document).ready(function () {
  	...
  	function getDataProductos(){
		...
		var route = "{{ url('/cliente/materiaPrima/DTproductos') }}";
		var idioma_espaniol = {
