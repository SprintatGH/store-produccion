...
<html>
<head>
    <title>Bootstrap 4 Password Strength Meter Example - Extra Css Classes for the Progress Bar</title>
    <link rel="stylesheet" media="screen" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" />
</head>
<body>
    <div class="container">
        <h1>Bootstrap 4 Password Strength Meter Example - Extra Css Classes for the Progress Bar</h1>
