...
<html>
<head>
    <title>Bootstrap 3 Password Strength Meter Example - Interact with Other Inputs</title>
    <link rel="stylesheet" media="screen" href="bootstrap3.css" />
</head>
<body>
    <div class="container">
        <h1>Bootstrap 3 Password Strength Meter Example - Interact with Other Inputs</h1>
