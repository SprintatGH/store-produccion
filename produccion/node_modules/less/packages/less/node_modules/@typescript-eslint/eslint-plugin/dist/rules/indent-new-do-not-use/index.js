...
const ast_utils_1 = require("eslint/lib/util/ast-utils");
...
const KNOWN_NODES = new Set([
    ...
    experimental_utils_1.AST_NODE_TYPES.JSXNamespacedName,
    ...
    experimental_utils_1.AST_NODE_TYPES.TSQuestionToken,
...
exports.default = util_1.createRule({
    ...
    create(context, [userIndent, userOptions]) {
        ...
        function countTrailingLinebreaks(str) {
            ...
            const linebreakMatches = trailingWhitespace.match(ast_utils_1.createGlobalLinebreakMatcher());
        ...
        const baseOffsetListeners = {
            'ArrayExpression, ArrayPattern'(node) {
                ...
                const closingBracket = sourceCode.getTokenAfter(node.elements[node.elements.length - 1] || openingBracket, eslint_utils_1.isClosingBracketToken);
