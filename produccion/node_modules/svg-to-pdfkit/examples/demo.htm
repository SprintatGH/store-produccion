...
<html>
<head>
  <title>SVG-to-PDFKit demo page</title>
...
function createPdf() {
  ...
  <style>
body               {margin:0;}
div#column-1       {position:fixed; height:100%; width:50%; top:0; left:0; overflow:auto;}
textarea#svg-code  {width:100%; height:120px; box-sizing:border-box; resize:vertical;}
div#column-1 > svg {border:1px dotted green; margin:3px;}
div#column-2       {position:fixed; height:100%; width:50%; top:0; right:0;}
iframe#pdf-file    {position:absolute; right:0; top:0; width:100%; height:100%; box-sizing:border-box; border:0;}
...
<body onload="createPdf()">
  <div id="column-1">
    <h1><a href="https://github.com/alafr/SVG-to-PDFKit">SVG-to-PDFKit</a> demo page</h1>
    <form>
      <textarea id="svg-code" onblur="createPdf()" placeholder="Paste svg code here, then click out of this textarea"></textarea>
      <label><input id="use-css" type="checkbox" onchange="createPdf()"/> Insert the SVG in the document and use the computed style</label>
      <p>&nbsp;</p>
    </form>
<!-- Beginning of example SVG files -->
<svg id="PreserveAspectRatio test © www.w3.org" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 480 360">
  <!--= SVG 1.1 2nd Edition Test Case = Copyright 2009 World Wide Web Consortium, (Massachusetts Institute of Technology, European Research Consortium for Informatics and Mathematics (ERCIM), Keio University). All Rights Reserved. See http://www.w3.org/Consortium/Legal/. =-->
...
<svg id="Textpaths are great" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 540 320">
 <defs>
  <path id="Triangle" d="M120 20 L 220 193.205 L 20 193.205 Z" stroke="red" fill="yellow"/>
  <path id="Maths" d="M250,50C380,50 350,150 480,150" stroke="blue" fill="none"/>
  <path id="Chemistry" transform="translate(-200,0) scale(1.5)" d="M250,50C380,50 350,150 480,150" stroke="blue" fill="none"/>
  <path id="Path" d="M20,240 C40,280 60,280 200,230 A100 100 0 0 1 300,260 L 330,280 Q 400,320 500,200" stroke="green" fill="none"/>
 </defs>
 <use xlink:href="#Triangle"/>
 <use xlink:href="#Maths"/>
 <use xlink:href="#Chemistry"/>
 <use xlink:href="#Path"/>
 <rect x="2%" y="2%" width="96%" height="96%" fill="none" stroke="orange" stroke-width="2" stroke-dasharray="5 2 2 2 5 5"/>
 <text textLength="600px" lengthAdjust="spacingAndGlyphs">
  <textPath xlink:href="#Triangle" font-size="20" textLength="600px" lengthAdjust="spacingAndGlyphs">Text adjusted around a triangle</textPath>
 </text>
 <text>
  <textPath xlink:href="#Maths" font-size="30" text-anchor="middle" startOffset="50%">Maths x<tspan font-size="20" baseline-shift="super">2</tspan> + y<tspan font-size="20" baseline-shift="super">2</tspan> = z<tspan font-size="20" baseline-shift="super">2</tspan>!</textPath>
  <textPath xlink:href="#Chemistry" font-size="30" text-anchor="middle" startOffset="50%">Chemistry 2H<tspan font-size="20" baseline-shift="sub">2</tspan> + O<tspan font-size="20" baseline-shift="sub">2</tspan> -> 2H<tspan font-size="20" baseline-shift="sub">2</tspan>O</textPath>
  <textPath xlink:href="#Path" font-size="30" dominant-baseline="middle" text-anchor="middle" startOffset="50%">Text centered on a complex path</textPath>
 </text>
</svg>
<svg id="Text gradient" xmlns="http://www.w3.org/2000/svg" viewBox="20 20 760 760">
  <radialGradient id="grad">
    <stop stop-color="green" offset="0.2"/>
    <stop stop-color="blue" offset="0.3"/>
    <stop stop-color="indigo" offset="0.4"/>
    <stop stop-color="violet" offset="0.5"/>
    <stop stop-color="darkred" offset="0.6"/>
    <stop stop-color="darkorange" offset="0.7"/>
    <stop stop-color="crimson" offset="0.8"/>
    <stop stop-color="green" offset="0.9"/>
    <stop stop-color="violet" offset="1"/>
  </radialGradient>
  <path stroke="orange" stroke-opacity="0.2" stroke-width="3" fill="none" d="M0,0C2,0,4-2,3-5,2-8-1-11-6-10-11-10-16-6-18,0-20,6-18,15-12,21-6,27,5,29,15,26,25,23,34,13,36,0,38-13,33-27,21-36,9-46-9-48-24-42-39-35-52-19-54,0-56,19-47,40-30,52-13,64,12,67,33,57,54,47,70,25,72,0,74-25,62-52,39-68,16-83-16-86-42-73-68-60-88-31-90,0-92,31-76,65-48,83-20,102,19,104,51,88,83,72,106,38,108,0,110-38,90-77,57-99,24-120-23-123-60-104-97-85-124-44-126,0-128,44-105,90-66,114-27,139,26,142,69,120,112,97,142,50,144,0,146-50,119-102,75-130,31-158-30-161-78-135-126-110-160-57-162,0-164,57-134,114-84,145-34,177,33,179,87,151,141,122,178,63,180,0,182-63,148-127,93-161,38-195-37-198-96-166-155-135-196-69-198,0-200,69-163,139-102,177-41,214,41,217,105,182,169,147,214,75,216,0,218-75,177-152,111-192,45-233-44-236-114-197-184-159-232-82-234,0-236,82-192,164-120,208-48,251,48,254,123,213,198,172,250,88,252,0,254-88,206-177,129-223,52-270-51-273-132-229-213-184-268-94-270,0-272,94-220,189-138,239-56,289,55,292,141,244,227,197,286,101,288,0" transform="translate(400,400) scale(1.2)" id="path"/>
  <text fill-opacity="0.6" stroke-linejoin="round" stroke="url(#grad)" font-size="45" font-family="serif" font-weight="bold" dominant-baseline="central" text-anchor="middle" fill="url(#grad)">
...
<svg id="Clipped Image (bottom aligned)" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 160 80" preserveAspectRatio="xMidYMax meet">
  <image xlink:href="data:image/jpeg;base64,"
 width="80" height="80" x="40" y="0" clip-path="url(#clip)"/> 
  <clipPath id="clip" clipPathUnits="objectBoundingBox">
    <ellipse cx="0.5" cy="0.44" rx="0.4" ry="0.39"/>
    <circle cx="0.18" cy="0.28" r="0.18"/>
    <circle cx="0.82" cy="0.33" r="0.18"/>
    <rect y="0.78" height="0.5" width="1" rx="0.22"/>
  </clipPath>
</svg>
<svg id="Shapes with opacity" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 400 300">
	<g transform="translate(200 50) rotate(60)" fill="green">
     <circle cx="100" cy="100" r="50" stroke="red" fill="rgba(125,125,125,0.2)" />
     <circle transform="scale(0.8 1.5)" cx="100" cy="100" r="50" stroke="blue" fill="rgba(125,125,125,0.4)" />
     <polyline points="30 30, 30 60, 60 60, 60 90, 90 90, 90 120" stroke="#FF00F0" fill="none" stroke-width="12" stroke-linejoin="round" />
     <rect x="0" y="0" width="50" height="50" fill="palegreen" />
     <g opacity="0.5" >
       <rect x="-25" y="-25" width="50" height="50" fill="magenta" opacity="0.5" fill-opacity="0.5"/>
       <rect x="-25" y="-25" width="50" height="50" transform="scale(0.8)" fill="magenta"/>
     </g>
     <line x1="0" y1="0" x2="0" y2="100" stroke="grey"/>
     <g transform="rotate(300) translate(0 -50) scale(0.5) rotate(15) translate(0 200)" stroke-width="3">
       <ellipse cx="200" cy="100" rx="200" ry="100" fill="blue" opacity="0.3"/>
       <ellipse cx="200" cy="100" rx="140" ry="70" fill="yellow" opacity="0.3"/>
       <ellipse cx="200" cy="100" rx="80" ry="40" fill="red" opacity="0.2"/>
       <path d="M200 0 L200 200" stroke="green"/>
       <path d="M0 100 L400 100" stroke="green"/>
     </g>
   </g>
</svg>
<svg id="Text and graphs © www.w3.org" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"  viewBox="0 0 600 400">
	<defs>
		<rect id="bar" width="196" height="21" fill="#88A4B9" stroke-fill="#DEE9EF" stroke-width="1"/>
		<line id="standard-pointer" x1="0" y1="0" x2="0" y2="14" stroke="black" stroke-width="1"/>
	</defs>
	<g transform="translate(95, 4)" font-size="12px">
		<g>
			<text class="title" font-weight="bold" x="0" y="13">Looking back</text>
			<text class="content" transform="translate(0, 21)">
				<tspan x="0" dy="13">Compare the way things are going in</tspan>
				<tspan x="0" dy="13">the United States with how they were</tspan>
				<tspan x="0" dy="13">going five years ago.</tspan>
			</text>
		</g>
		<g transform="translate(0, 99)">
			<text class="date" font-weight="bold" transform="translate(-49, -5)">
				<tspan x="0" dy="13">Apr.</tspan>
				<tspan x="0" dy="13">2008</tspan>
			</text>
			<use xlink:href="#bar" x="0" y="0"/>
			<rect class="bar-section" fill="#C4CDD2" stroke-fill="#E3E7EA" stroke-width="1" x="9" y="0" width="34" height="21"/>
			<text x="1" y="15">4</text>
			<text x="18" y="15">17</text>
			<use xlink:href="#standard-pointer" transform="translate(4, -10)"/>
			<text x="1" y="-12">Better</text>
			<text class="percentage" font-weight="bold" x="163" y="15">78%</text>
			<use xlink:href="#standard-pointer" transform="translate(177, -10)"/>
			<text x="158" y="-12">Worse</text>
		</g>
		<g transform="translate(0, 134)">
			<text class="date" font-weight="bold" transform="translate(-49, -5)">
				<tspan x="0" dy="13">Jan.</tspan>
				<tspan x="0" dy="13">2009</tspan>
			</text>
			<use xlink:href="#bar" x="0" y="0"/>
			<rect class="bar-section" fill="#C4CDD2" stroke-fill="#E3E7EA" stroke-width="1" x="11" y="0" width="20" height="21"/>
			<text x="1" y="15">5</text>
			<text x="14" y="15">10</text>
			<g transform="translate(23, 18)">
				<path d="M0 0 V15 H7" stroke="black" stroke-width="1" fill="none"/>
				<text x="11" y="18">About the same</text>
			</g>
			<text class="percentage" font-weight="bold" x="163" y="15">83%</text>
		</g>
	</g>
	<g transform="translate(95, 192)"  font-size="12px">	
		<g>
			<text class="title" font-weight="bold" x="0" y="13">Jobs</text>
			<text class="content" transform="translate(0, 21)">
				<tspan x="0" dy="13">When it comes to the availability of</tspan>
				<tspan x="0" dy="13">good jobs for American workers, do</tspan>
				<tspan x="0" dy="13">you think America's best years</tspan>
				<tspan x="0" dy="13">behind us or yet to come?</tspan>
			</text>
		</g>
		<g transform="translate(0, 109)">
			...
			<use xlink:href="#bar" x="0" y="0"/>
			<rect class="bar-section" fill="#C4CDD2" stroke-fill="#E3E7EA" stroke-width="1" x="98" y="0" width="17" height="21"/>
			<text x="4" y="15">48</text>
			<text x="103" y="15">9</text>
			<use xlink:href="#standard-pointer" transform="translate(8, -10)"/>
			<text x="1" y="-12">Behind us</text>
			<text class="percentage" font-weight="bold" x="163" y="15">43%</text>
			<use xlink:href="#standard-pointer" transform="translate(177, -10)"/>
			<text x="126" y="-12">Yet to come</text>
		</g>
		<g transform="translate(0, 144)">
			...
			<use xlink:href="#bar" x="0" y="0"/>
			<rect class="bar-section" fill="#C4CDD2" stroke-fill="#E3E7EA" stroke-width="1" x="72" y="0" width="14" height="21"/>
			<text x="4" y="15">35</text>
			<text x="75" y="15">8</text>
			<g transform="translate(79, 18)">
				<path d="M0 0 V15 H7" stroke="black" stroke-width="1" fill="none"/>
				<text x="11" y="18">No opinion</text>
			</g>
			<text class="percentage" font-weight="bold" x="163" y="15">57%</text>
		</g>
	</g>
	<text class="source" font-style="italic" font-size="9.33" x="95" y="387">Source: New York Times/CBS News Polls</text>
	<line x1="320" y1="13" x2="320" y2="373" stroke-dasharray="1 2" stroke="#B2B2B2"/>
	<g transform="translate(349, 4)"  font-size="12px">	
		<g>
			<text class="title" font-weight="bold" x="0" y="13">Looking ahead</text>
			<text class="content" transform="translate(0, 21)">
				<tspan x="0" dy="13">What is your best guess about the</tspan>
				<tspan x="0" dy="13">United States five years from now if</tspan>
				<tspan x="0" dy="13">things go pretty much as you expect?</tspan>
			</text>
		</g>
		<g transform="translate(0, 99)">
			<use xlink:href="#bar" x="0" y="0"/>
			<rect class="bar-section" fill="#C4CDD2" stroke-fill="#E3E7EA" stroke-width="1" x="85" y="0" width="41" height="21"/>
			<text x="4" y="15">39</text>
			<text x="97" y="15">19</text>
			<use xlink:href="#standard-pointer" transform="translate(4, -10)"/>
			<text x="1" y="-12">Better</text>
			<text class="percentage" font-weight="bold" x="163" y="15">34%</text>
			<use xlink:href="#standard-pointer" transform="translate(177, -10)"/>
			<text x="158" y="-12">Worse</text>
		</g>
		<g transform="translate(0, 134)">
			<use xlink:href="#bar" x="0" y="0"/>
			<rect class="bar-section" fill="#C4CDD2" stroke-fill="#E3E7EA" stroke-width="1" x="125" y="0" width="32" height="21"/>
			<text x="4" y="15">61</text>
			<text x="133" y="15">17</text>
			<g transform="translate(52, 18)">
				<text x="0" y="18">About the same</text>
				<path d="M92 0 v15 h-4" stroke="black" stroke-width="1" fill="none"/>
			</g>
			<text class="percentage" font-weight="bold" x="163" y="15">19%</text>
		</g>
	</g>
	<g transform="translate(349, 192)" font-size="12px">	
		<g>
			<text class="title" font-weight="bold" x="0" y="13">Economy</text>
			<text class="content" transform="translate(0, 21)">
				<tspan x="0" dy="13">How would you rate the condition of</tspan>
				<tspan x="0" dy="13">the national economy these days?</tspan>
			</text>
		</g>
		<g transform="translate(0, 75)">
			...
			<g id="graph-lines">
				<line class="graph-line" stroke-dasharray="1 2" stroke="#B2B2B2" x1="18" y1="6" x2="192" y2="6"/>
				<line class="graph-line" stroke-dasharray="1 2" stroke="#B2B2B2" x1="18" y1="25" x2="192" y2="25"/>
				<line class="graph-line" stroke-dasharray="1 2" stroke="#B2B2B2" x1="18" y1="44" x2="192" y2="44"/>
				<line class="graph-line" stroke-dasharray="1 2" stroke="#B2B2B2" x1="18" y1="63" x2="192" y2="63"/>
				<line class="graph-line" stroke-dasharray="1 2" stroke="#B2B2B2" x1="18" y1="82" x2="192" y2="82"/>
			</g>
			<g id="horizontal-axis">
				<line class="tick" stroke="black" stroke-width="0.5" x1="30" y1="81" x2="30" y2="88"/>
				<text x="16" y="101">Jan.08</text>
				<line class="tick" stroke="black" stroke-width="0.5" x1="39" y1="81" x2="39" y2="85"/>
				<line class="tick" stroke="black" stroke-width="0.5" x1="48" y1="81" x2="48" y2="85"/>
				<line class="tick" stroke="black" stroke-width="0.5" x1="57" y1="81" x2="57" y2="85"/>
				<line class="tick" stroke="black" stroke-width="0.5" x1="66" y1="81" x2="66" y2="85"/>
				<line class="tick" stroke="black" stroke-width="0.5" x1="75" y1="81" x2="75" y2="85"/>
				<line class="tick" stroke="black" stroke-width="0.5" x1="84" y1="81" x2="84" y2="85"/>
				<line class="tick" stroke="black" stroke-width="0.5" x1="93" y1="81" x2="93" y2="85"/>
				<line class="tick" stroke="black" stroke-width="0.5" x1="102" y1="81" x2="102" y2="85"/>
				<line class="tick" stroke="black" stroke-width="0.5" x1="111" y1="81" x2="111" y2="88"/>
				<text x="92" y="101">July.08</text>
				<line class="tick" stroke="black" stroke-width="0.5" x1="120" y1="81" x2="120" y2="85"/>
				<line class="tick" stroke="black" stroke-width="0.5" x1="129" y1="81" x2="129" y2="85"/>
				<line class="tick" stroke="black" stroke-width="0.5" x1="138" y1="81" x2="138" y2="85"/>
				<line class="tick" stroke="black" stroke-width="0.5" x1="147" y1="81" x2="147" y2="85"/>
				<line class="tick" stroke="black" stroke-width="0.5" x1="156" y1="81" x2="156" y2="85"/>
				<line class="tick" stroke="black" stroke-width="0.5" x1="165" y1="81" x2="165" y2="85"/>
				<line class="tick" stroke="black" stroke-width="0.5" x1="174" y1="81" x2="174" y2="85"/>
				<line class="tick" stroke="black" stroke-width="0.5" x1="183" y1="81" x2="183" y2="85"/>
				<line class="tick" stroke="black" stroke-width="0.5" x1="192" y1="81" x2="192" y2="88"/>
				<text x="155" y="101">Jan.09</text>
			</g>
			<text x="61" y="-3">Fairly or very bad 92%</text>
			<path d="M185 -8 h4 v12" stroke="black" stroke-width="1" fill="none"/>
			<path d="M28 70 L37 49 L46 52 L55 40 L63 36 L72 39 L80 27 L89 36 L105 22 L114 24 L122 32 L132 28 L139 16 L150 16 L164 23 L181 12 L190 5" fill="none" stroke-width="3" stroke="#38688E"/>
		</g>
	</g>
	<text class="publisher" font-size="9.33" x="440" y="387">THE NEW YORK TIMES</text>
</svg>
<svg id="Chemical danger © www.w3.org" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"  viewBox="0 0 600 500">
  <g transform="scale(0.5) translate(612 0) translate(-532.5 0)" fill="black">
...
<svg id="Planets © www.w3.org" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"  viewBox="0 0 500 400">
  <defs>
    <g id="def" transform="translate(50,0) scale(2)">
  ...
  <use x="0" y="0" xlink:href="#def"/>
  <use x="200" y="0" xlink:href="#def"/>
  <use transform="translate(-200 200)" x="200" y="0" xlink:href="#def"/>
  <use x="200" y="200" xlink:href="#def"/>
</svg>
<svg id="Tiger (I love this one!) © www.w3.org" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"  viewBox="0 0 600 600">
 <g transform="translate(200,200)" fill-opacity="1" fill="none">
 <g fill="#ffffff" stroke="#000000" stroke-width="0.172">
 ...
 <g fill="#ffffcc" stroke="#000000" stroke-width="0.5">
...
<svg id="Various attributes" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 160" preserveAspectRatio="xMidYMid meet">
  <rect x="20" y="20" width="320" height="120"
    stroke="red" stroke-width="0.5cm" stroke-dasharray="12 28"
    stroke-dashoffset="-14" stroke-opacity="1"
    fill="blue" fill-opacity="0.3" />
  <text x="20" y="20"
    letter-spacing="2pt" word-spacing="0.25cm"
    fill="orange" stroke="green" stroke-width=".6%"
    font-size="40" font-weight="bold" font-family="sans-serif"
    dominant-baseline="middle" text-anchor="middle"
    transform="translate(200 60) scale(2) translate(-20 0) scale(0.5)">Sample text</text>
</svg>
<!-- End of example SVG files -->
  </div>
  <div id="column-2">
