...
<script>
 var customTemplates = {
      custombuttons: function(customOptions) {
          ...
          return "<li>" +
              "<div class='btn-group'>" +
              "<a class='btn btn-default" + size + "' data-wysihtml5-command='insertHTML' data-wysihtml5-command-value='&hellip;' title='CTRL+B' tabindex='-1'>&hellip</a>" +
              "</div>" +
              "</li>";
      },
  };
  ...
  $('.editable').wysihtml5({
    ...
    events: {
      'load': function() { 
        $('.editable').html('Some text here after loading.');
        console.log('loaded!');
      }
    },
    locale: 'de-DE',
