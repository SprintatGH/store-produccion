            ...
            <div class="invoice">
				...
				<div class="invoice-company">
					<span class="pull-right hidden-print">
						<a href="{{ route('CA_ventas_cotizaciones.exportar', $id ) }}" class="btn btn-sm btn-white m-b-10"><i class="fa fa-file-pdf t-plus-1 text-danger fa-fw fa-lg"></i> Exportar a PDF</a>
				...
				<div class="invoice-header">
					...
					<div class="invoice-date">
						<small>Fecha</small>
						<div class="date text-inverse m-t-5">{{ $fecha }}</div>
