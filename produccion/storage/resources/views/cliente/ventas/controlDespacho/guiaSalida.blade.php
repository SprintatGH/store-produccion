...
<body>
            ...
            <div class="pdf-content">
				...
				<span class="m-r-10">( {{ $ca_venta_cot->descripcion }} )</span>
				...
				<div class="pdf-content-header">
							...
							<tr>
								<td class="td-30" >
									<div class="pdf-content-from ">
										<img src="{{asset('imagenes/logos/8.jpg')}}" alt="Logo" height="150px">
									</div>
								</td>
								<td class="td-30" >
									<div class="pdf-content-from ">
					...
					<div class="pdf-content-header">
						<table class="table table-pdf">
							<thead>
								<tr>
									<th class="titulo-producto-center" width="30%">NOMBRE</th>
