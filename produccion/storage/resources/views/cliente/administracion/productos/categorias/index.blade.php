											...
											<tbody>
												@foreach ($contenido as $items)
													<tr>
														...
														<td class="with-btn" >
															@if ($items->estado==1)
															<a href="#" onclick="cambioEstado(this)" id="In" data-href="{{route('CA_productos_categoria.estado',[ $items->id ,0])  }}"> <span  class="badge bg-danger">In</span></a>
															@else
	...
	<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="{{ route('CA_producto_categoria.update') }}" class="form-horizontal" data-parsley-validate="true">
							@csrf
