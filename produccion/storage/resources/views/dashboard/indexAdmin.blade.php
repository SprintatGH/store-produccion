			...
			<div class="col-xl-4 col-lg-6"> 
				<div class="card border-0 mb-3 bg-dark-darker text-white"> 
					<div class="card-body" >
						...
						<h3 class="m-b-10">Actual: <span data-animation="number" data-value="{{$sumaStockActual}}">0.00</span></h3> 
					</div>  
						...
						@foreach ($contenido as $items)
							<a href="#" class="widget-list-item rounded-0 p-t-3">
								...
								<div class="widget-list-content" >
									...
									@else
										<td class="with-img"><img src="/files/productos/{{ $items->avatar }}" width="30" height="30" /></td>
									@endif
										{{ $items->nombre }}
									</div>
									<div class="text-grey">Stock Mínimo {{ $items->stock_minimo }}</div>
								</div>
								<div class="widget-list-action text-nowrap text-grey">
									<div class="f-s-13"><span data-animation="number" data-value="{{$items->stock_actual}}">0</span></div>
								</div>
							</a>
						@endforeach
			...
			<div class="col-xl-4 col-lg-6"> 
				<div class="card border-0 mb-3 bg-dark-darker text-white"> 
					<div class="card-body" >
						...
						<h3 class="m-b-10">$<span data-animation="number" data-value="{{$sumaStockActual}}">0.00</span></h3> 
					</div>  
					<div class="widget-list widget-list-rounded inverse-mode"> 
