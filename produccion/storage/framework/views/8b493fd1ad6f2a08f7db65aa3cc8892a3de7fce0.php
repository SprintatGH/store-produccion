								...
								<div class="panel-body">
                                    ...
                                    <div class="row row-space-30">
										...
										<div class="col-xl-3">
                                            ...
                                            <p class="m-b-10"> <code>
											   <?php if($encabezado->estado == 0): ?>
											    	Eliminada
											   <?php elseif($encabezado->estado == 1): ?>
											   		Abierto
  												<?php else: ?>
  													Cerrado
												<?php endif; ?>
                                    ...
                                    <div class="table-responsive">
										<table class="table table-striped">
											...
											<div class="float-left">
												...
												<?php endif; ?>
												<a href="<?php echo e(route('CA_control_despacho.vista_previa',$encabezado->id)); ?>" class="btn btn-sm btn-white m-b-10"><i class="fa fa-file-pdf t-plus-1 text-success fa-fw fa-lg"></i> </a>
											</div>


											<div class="float-right">
												<a href="<?php echo e(route('CA_control_despacho.cambio_estado',[$encabezado->id,$encabezado->estado])); ?>" class="btn btn-sm btn-white m-b-10">
													<?php if($encabezado->estado == 0): ?>
														Abrir Despacho
													<?php elseif($encabezado->estado == 1): ?>
														Cerrar Despacho
													...
													<tr>
														...
														<td class="with-btn">
															...
															<?php if($items->estado==1): ?>
																<?php if($encabezado->estado == 1): ?>
																	<a href="#" onclick="cambioEstado(this)" id="In" data-href="<?php echo e(route('CA_control_despacho.estado_detalle',[ $items->id ,0])); ?>"> <span  class="btn btn-sm btn-white m-b-10"><i class="fa fa-trash t-plus-1 text-success fa-fw fa-lg"></i></span></a>
  																<?php else: ?>
																    <a href="#" > <span  class="btn btn-sm btn-white m-b-10"><i class="fa fa-trash t-plus-1 text-alert fa-fw fa-lg"></i></span></a>
																<?php endif; ?>  
															<?php else: ?>
																<?php if($encabezado->estado == 1): ?>
																<a href="#" onclick="cambioEstado(this)" id="In" data-href="<?php echo e(route('CA_control_despacho.estado_detalle',[ $items->id ,1])); ?>"> <span class="badge bg-success">Ac</span></a>
  																<?php else: ?>
														...
														<td><?php echo e($items->nombre_formato); ?></td>
	...
	<div class="modal fade" id="modal-add">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="<?php echo e(route('CA_control_despacho.store_detalle')); ?>" class="form-horizontal" data-parsley-validate="true">
							<?php echo csrf_field(); ?>
...
<script type="text/javascript">
    $('#productos').change(function() {
        ...
        var cod=this.value;
        var route = "<?php echo e(url('/cliente/ventas/controlDespacho')); ?>/"+cod+"/precios";
		console.log(route);
        $.get(route, function(data){ 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jpabl\OneDrive\Escritorio\respaldo\store-sp-pro\produccion\resources\views/cliente/ventas/controlDespacho/detalle.blade.php ENDPATH**/ ?>