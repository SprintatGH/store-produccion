		...
		<ul class="nav">
			<li class="nav-profile">
				<a href="javascript:;" data-toggle="nav-profile">
					...
					<div class="image">
						<img src="/files/empresas/logos/<?php echo e(session('logo')); ?>" alt="" />
					</div>
					<div class="info">
...
<?php /**PATH C:\Users\jpabl\OneDrive\Escritorio\respaldo\store-sp-pro\produccion\resources\views/includes/sidebar.blade.php ENDPATH**/ ?>