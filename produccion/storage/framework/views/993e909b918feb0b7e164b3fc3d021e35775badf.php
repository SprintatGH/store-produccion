...
<?php $__env->startSection('content'); ?>
   ...
   <?php if($action == "listado"): ?> 
				...
				<ol class="breadcrumb float-xl-right">
						...
						<li class="breadcrumb-item"><a href="javascript:;">Materia Prima</a></li>
                        <li class="breadcrumb-item"><a href="javascript:;">Parametros</a></li>
	...
	<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="<?php echo e(route('CA_productos_categoriaMP.update')); ?>" class="form-horizontal" data-parsley-validate="true">
							<?php echo csrf_field(); ?>
	...
	<div class="modal fade" id="modal-add">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="<?php echo e(route('CA_productos_categoriaMP.store')); ?>" class="form-horizontal" data-parsley-validate="true">
							<?php echo csrf_field(); ?>
...
function getDataProductos(){
    ...
    var route = "<?php echo e(url('/cliente/materiaPrima/productos/DTcategoria')); ?>";
    var idioma_espaniol = {
        ...
        success: function(data){
            ...
            if (data.length > 0)
            {
                ...
                for (var i=0; i<data.length; i++){
                    ...
                    if (data[i].estado == 1) {
                        var estado = "<a href='#' onclick='cambioEstado(this)' id='In' data-href='/cliente/materiaPrima/productos/categoria/" + data[i].id + "/0/estado'> <span  class='btn btn-sm btn-white m-b-10'><i class='fa fa-trash t-plus-1 text-success fa-fw fa-lg'></i></span></a>";
                    } else  {
                        var estado = "<a title='Venta Cerrada - Deshabilitado opción Eliminar' href='#'> <span  class='btn btn-xs btn-white m-b-3'><i class='fa fa-trash t-plus-1 text-alert fa-fw fa-lg'></i></span><<a href='#' onclick='cambioEstado(this)' id='In' data-href='/cliente/materiaPrima/productos/categoria/" + data[i].id + "/1/0estado'> <span class='badge bg-success'>Ac</span></a>";
                    } 
...
{
    var route = "<?php echo e(url('/cliente/materiaPrima/productos/categoria')); ?>/"+id+"/edit";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jpabl\OneDrive\Escritorio\respaldo\store-sp-pro\produccion\resources\views/cliente/materiaPrima/productos/categoria/index.blade.php ENDPATH**/ ?>