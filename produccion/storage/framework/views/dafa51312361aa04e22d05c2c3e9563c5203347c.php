<?php $__env->startSection('title', 'Materia Prima - Clientes'); ?>
	...
	<div class="modal fade" id="modal-add">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="<?php echo e(route('CA_ClientesMP.store')); ?>" class="form-horizontal" data-parsley-validate="true">
							<?php echo csrf_field(); ?>
...
<script>
        ...
        function getDataClientes(){
            ...
            var route = "<?php echo e(url('/cliente/materiaPrima/DTclientes')); ?>";
            var idioma_espaniol = {
                ...
                success: function(data){
                    ...
                    if (data.length > 0)
                    {
                        ...
                        for (var i=0; i<data.length; i++){
                            info = [
                                "<a href='#' onclick='cambioEstado(this)' id='In' data-href='/cliente/materiaPrima/clientes/" + data.id + "/0/estado'> <span  class='btn btn-xs btn-white m-b-10'><i class='fa fa-trash t-plus-1 text-success fa-fw fa-sm'></i></span></a>",
                                data[i].id,
                                data[i].nombre,
                                data[i].nombre,
                                data[i].email,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jpabl\OneDrive\Escritorio\respaldo\store-sp-pro\produccion\resources\views/cliente/materiaPrima/clientes/index.blade.php ENDPATH**/ ?>