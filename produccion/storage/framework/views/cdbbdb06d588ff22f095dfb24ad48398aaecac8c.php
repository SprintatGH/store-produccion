<?php $__env->startSection('title', 'Managed Tables - Autofill'); ?>
	...
	<div class="row">
		...
		<div class="col-xl-2">
			...
			<ul class="p-l-25 m-b-15">
				<li>Basic initialisation</li>
				<li>Column options</li>
				<li>Scrolling DataTable</li>
				<li>Horizontal and vertical fill</li>
				<li>Horizontal fill</li>
				<li>Complete callback</li>
				<li>Step callback</li>
			</ul>
			<p class="m-b-20">
				<a href="http://www.datatables.net/extensions/autofill/" target="_blank" class="btn btn-inverse btn-sm">View Official Website</a>
			</p>
		</div>
		<!-- end col-2 -->
		<!-- begin col-10 -->
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\temp\resources\views/pages/table-manage-autofill.blade.php ENDPATH**/ ?>