<?php $__env->startSection('title', 'Managed Tables - RowReorder'); ?>
...
<?php $__env->startSection('content'); ?>
	...
	<div class="row">
		...
		<div class="col-xl-2">
			...
			<p class="m-b-20">
				<a href="http://www.datatables.net/extensions/rowreorder/" target="_blank" class="btn btn-inverse btn-sm">View Official Website</a>
			</p>
		</div>
		<!-- end col-2 -->
		<!-- begin col-10 -->
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\temp\resources\views/pages/table-manage-rowreorder.blade.php ENDPATH**/ ?>