	...
	<div class="row">
		...
		<div class="col-xl-2">
			...
			<ul class="p-l-25 m-b-15">
				<li>Operating system (os) style - where a single click will select a single item only, deselecting any others that were previously selected, a shift click will select a range of items and a ctrl / cmd click will add and remove items from the selection.</li>
				<li>Single item select (single) - only a single item can be selected at any one time. Any previously selected items will be deselected.</li>
				<li>Multi-item selection (multi) - item selection is toggled with a single click.</li>
			</ul>
			<p class="m-b-20">
				<a href="http://www.datatables.net/extensions/select/" target="_blank" class="btn btn-inverse btn-sm">View Official Website</a>
			</p>
		</div>
		<!-- end col-2 -->
		<!-- begin col-10 -->
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\temp\resources\views/pages/table-manage-select.blade.php ENDPATH**/ ?>