...
<?php $__env->startSection('title', 'Cotización - PDF'); ?>
            ...
            <div class="invoice">
				...
				<div class="invoice-company">
					<span class="pull-right hidden-print">
						<a href="<?php echo e(route('CA_control_despacho.exportar', $id )); ?>" class="btn btn-sm btn-white m-b-10"><i class="fa fa-file-pdf t-plus-1 text-danger fa-fw fa-lg"></i> Exportar a PDF</a>
						
					</span>
					Control de Despacho N° <?php echo e($id); ?> 
				...
				<div class="invoice-header">
					<div class="invoice-from">
						...
						<td class="with-img"><img src="/imagenes/logos/<?php echo e(session('id_empresa')); ?>.jpg" class="img-rounded height-150" /></td>
					...
					<div class="invoice-from">
						...
						<address class="m-t-5 m-b-5">
							...
							Email:<?php echo e($info_empresa->email); ?><br />
					...
					<div class="invoice-date">
						<small>Fecha</small>
						<div class="date text-inverse m-t-5"><h2><?php echo e($fecha); ?></h2></div>
				...
				<div class="invoice-note"> </div>
					...
					<small>( <?php echo e($ca_venta_cot->descripcion); ?> )</small>						
				...
				<div class="invoice-footer">
					...
					<p class="text-center">
						...
						<span class="m-r-10"><i class="fa fa-fw fa-lg fa-phone-volume"></i> <?php echo e($info_empresa->telefono); ?></span>
						<span class="m-r-10"><i class="fa fa-fw fa-lg fa-envelope"></i> <?php echo e($info_empresa->email); ?> </span>
					</p>
				</div>
				<!-- end invoice-footer -->
			</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jpabl\OneDrive\Escritorio\respaldo\store-sp-pro\produccion\resources\views/cliente/ventas/controlDespacho/vista_previa.blade.php ENDPATH**/ ?>