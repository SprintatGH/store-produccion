...
<?php $__env->startSection('content'); ?>
   ...
   <?php if($action == "listado"): ?> 
													...
													<tr>
														...
														<td class="with-btn" >
															<?php if($items->estado==1): ?>
																<a href="#" onclick="cambioEstado(this)" id="In" data-href="<?php echo e(route('CA_clientes.estado',[ $items->id ,0])); ?>"> <span  class="btn btn-xs btn-white m-b-10"><i class="fa fa-trash t-plus-1 text-success fa-fw fa-sm"></i></span></a>
															<?php else: ?>
															...
															<a href="#" onclick="precio_especial(<?php echo e($items->id); ?>)"  data-toggle="modal" data-id="<?php echo e($items->id); ?>" data-target="#modal-precio-especial"> <span  class="btn btn-xs btn-white m-b-10"><i class="fa fa-cart-plus t-plus-1 text-success fa-fw fa-sm"></i></span></a>
														</td>
	...
	<div class="modal fade" id="modal-precio-especial">
	<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">Agregar Precio Especial</h4>
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
				</div>
				<div class="modal-body">
					<p>
						<form method="POST" action="<?php echo e(route('CA_clientes.precioEspecial')); ?>" class="form-horizontal" data-parsley-validate="true">
							<?php echo csrf_field(); ?>
							 <input type="hidden" id="id_cliente" name="id_cliente">

							 	<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="producto">Productos :</label>
									<div class="col-md-8 col-sm-8">
								...
								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="productoPrecio">Precio * :</label>
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="text" id="productoPrecio" name="productoPrecio"  data-parsley-required="true" />
									</div>
								</div>
						...
						<div class="table-responsive">
							<table class="table table-striped" name="tablePrecios" id="tablePrecios">
...
var precio_especial= function(id)
{
	$("#tablePrecios tr").remove(); 
	var route =("<?php echo e(url('/cliente/administracion/clientes')); ?>/"+id+"/productos");
	$.get(route, function(data){
				$("#id_cliente").val(id);
				$("#tablePrecios").append('<tr><td>ID</td>'+
				'<td>Producto</td>' + 
				'<td align="center">Precio</td>' + 
				'<td align="center">Fecha</td>');
				for (i = 0; i < data.length; i++){
					
					$("#tablePrecios").append('<tr>' + 
					'<td align="center" style="dislay: none;">' + data[i].id + '</td>'+
					'<td align="left" style="dislay: none;">' + data[i].nomProducto + '</td>'+
					'<td align="center" style="dislay: none;">' + data[i].precio + '</td>'+
					'<td align="center" style="dislay: none;">' + data[i].fecha + '</td>'+'</tr>');
				}
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jpabl\OneDrive\Escritorio\respaldo\store-sp-pro\produccion\resources\views/cliente/administracion/clientes/index.blade.php ENDPATH**/ ?>