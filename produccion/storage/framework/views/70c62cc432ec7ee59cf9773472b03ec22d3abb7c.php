							...
							<tr>
								...
								<td class="td-60" >
									<div class="pdf-content-from ">
										...
										<strong class="text-inverse"> Total Proyección Precio Unitario: <?php echo e(number_format(App\Modelos\ca\administracion\CA_ProductosStock::TotalProyeccionPrecioUnitario(),0)); ?></strong><br />
										<strong class="text-inverse"> Total Proyección Precio Por mayor: <?php echo e(number_format(App\Modelos\ca\administracion\CA_ProductosStock::TotalProyeccionPrecioPorMayor(),0)); ?></strong><br />
							...
							<tbody>
								...
								<?php $__currentLoopData = $contenido; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
										...
										<td style='font-size: 9px;' class="text-center"><?php echo e(number_format($items->precio_unitario,0)); ?></td>
										<td style='font-size: 9px;' class="text-center"><?php echo e(number_format(App\Modelos\ca\administracion\CA_ProductosStock::proyeccionPrecioUnitario($items->id),0)); ?></td>
                                        <td style='font-size: 9px;' class="text-center"><?php echo e(number_format($items->precio_por_mayor,0)); ?></td>
                                        <td style='font-size: 9px;' class="text-center"><?php echo e(number_format(App\Modelos\ca\administracion\CA_ProductosStock::proyeccionPrecioPorMayor($items->id),0)); ?></td>
...
</html><?php /**PATH C:\Users\jpabl\OneDrive\Escritorio\respaldo\store-sp-pro\produccion\resources\views/cliente/administracion/productos/reportes/productosProyeccionVentas.blade.php ENDPATH**/ ?>