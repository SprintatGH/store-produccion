            ...
            <div class="invoice">
				...
				<div class="invoice-company">
					<span class="pull-right hidden-print">
						<a href="<?php echo e(route('CA_ventas_cotizaciones.exportar', $id )); ?>" class="btn btn-sm btn-white m-b-10"><i class="fa fa-file-pdf t-plus-1 text-danger fa-fw fa-lg"></i> Exportar a PDF</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\store-sftp-local\sistemas\desarrollo\resources\views/cliente/ventas/cotizaciones/vista_previa.blade.php ENDPATH**/ ?>