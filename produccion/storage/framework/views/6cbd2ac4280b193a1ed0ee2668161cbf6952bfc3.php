            ...
            <div class="pdf-content">
							...
							<tr>
								<td class="td-30" >
									<div class="pdf-content-from ">
										<img src="<?php echo e(asset('imagenes/logos/8.jpg')); ?>" alt="Logo" height="120px">
									</div>
								</td>
								<td class="td-30" >
									<div class="pdf-content-from ">
											...
											<div class="m-t-4 m-b-4">
												...
												Mail:<?php echo e($info_empresa->email); ?><br /><br />
											</div>
									</div>
								</td>
								<td class="td-30">
				...
				<div class="pdf-content-footer">
					...
					<p class="text-center">
						...
						<span class="m-r-10"><i class="fa fa-fw fa-lg fa-phone-volume"></i> Teléfono:<?php echo e($info_empresa->telefono); ?></span>
						<span class="m-r-10"><i class="fa fa-fw fa-lg fa-envelope"></i> Email:<?php echo e($info_empresa->email); ?> </span>
					</p>
				</div>
...
</html><?php /**PATH /home2/cst62160/sistemas/produccion/resources/views/cliente/ventas/controlDespacho/guiaSalida.blade.php ENDPATH**/ ?>