	...
	<div class="row">
		...
		<div class="col-xl-3 col-md-6">
			<div class="widget widget-stats bg-teal">
				...
				<div class="stats-content">
					<div class="stats-title">Cotizaciones pendientes</div>
					<div class="stats-number">4</div>
					<div class="stats-progress progress">
						<div class="progress-bar" style="width: 70.1%;"></div>
					</div>
					<div class="stats-desc">El último mes (70.1%)</div>
				</div>
			</div>
		</div>
		<!-- end col-3 -->
		...
		<div class="col-xl-3 col-md-6">
			<div class="widget widget-stats bg-indigo">
				...
				<div class="stats-content">
					<div class="stats-title">Stock productos mensual</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\store-sftp-local\sistemas\desarrollo\resources\views/dashboard/indexAdmin.blade.php ENDPATH**/ ?>