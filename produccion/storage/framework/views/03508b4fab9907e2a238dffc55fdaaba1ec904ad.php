								...
								<?php $__currentLoopData = $contenido; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
										...
										<!-- <?php if(isset($items->avatar)): ?>
											<td ><img src="<?php echo e(asset('/files/productos/'.$items->avatar)); ?>"  alt="Logo" height="30px" /></td>
										<?php else: ?>
											<td ><img src="<?php echo e(asset('/files/productos/sin_imagen.png')); ?>" alt="Logo" height="30px"/></td>
										<?php endif; ?> -->
                                        ...
                                        <td style='font-size: 9px;' class="text-center"><?php echo e($items->precio_unitario); ?></td>
                                        <td style='font-size: 9px;' class="text-center"><?php echo e($items->precio_por_mayor); ?></td>
...
</html><?php /**PATH C:\Users\jpabl\OneDrive\Escritorio\respaldo\store-sp-pro\produccion\resources\views/cliente/administracion/productos/reportes/productosPDF.blade.php ENDPATH**/ ?>