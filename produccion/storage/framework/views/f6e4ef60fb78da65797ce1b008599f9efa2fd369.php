...
<?php $__env->startSection('content'); ?>
   ...
   <?php if($action == "listado"): ?> 
				...
				<ol class="breadcrumb float-xl-right">
					...
					<h1 class="page-header">Listado <small>Usuarios</small></h1>
					<div class="row">
						<div class="col-xl-12">
												...
												<?php $__currentLoopData = $contenido; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<tr>
														...
														<td class="with-btn" >
															...
															<a href="#" onclick="cambioEstado(this)" id="In" data-href="<?php echo e(route('AD_Usuarios.estado',[ $items->id ,0])); ?>"> <span  class="btn btn-sm btn-white m-b-10"><i class="fa fa-trash t-plus-1 text-success fa-fw fa-lg"></i></span></a>
																<?php else: ?>
															<a href="#" onclick="cambioEstado(this)" id="In" data-href="<?php echo e(route('AD_Usuarios.estado',[ $items->id ,1])); ?>"> <span class="badge bg-success">Ac</span></a>
															<?php endif; ?>
														</td>
														...
														<td><?php echo e($items->perfil); ?></td>
														<td><?php echo e($items->empresa); ?></td>
														<td><?php echo e($items->fono); ?></td>
	...
	<div class="modal fade" id="modal-add">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="<?php echo e(route('AD_Usuarios.store')); ?>" class="form-horizontal" data-parsley-validate="true">
							<?php echo csrf_field(); ?>
								...
								<div class="form-group row m-b-15">
									...
									<div class="col-md-8 col-sm-8">
										<select class="form-control" name="empresa" >
											<?php $__currentLoopData = $empresas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="perfil">Perfil * :</label>
									<div class="col-md-8 col-sm-8">
								...
								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="contraseña">Contraseña :</label>
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="password" id="contraseña" name="contraseña" placeholder="Requerido" data-parsley-required="true" />
									</div>
								</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jpabl\OneDrive\Escritorio\GitSprintat\store-sp\produccion\resources\views/administrador/usuarios/index.blade.php ENDPATH**/ ?>