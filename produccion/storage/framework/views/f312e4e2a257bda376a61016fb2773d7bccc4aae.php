   ...
   <?php if($action == "listado"): ?> 
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="<?php echo e(route('CA_productosMP.reporte_pdf')); ?>" class="form-horizontal" data-parsley-validate="true">
							<?php echo csrf_field(); ?>
	...
	<div class="modal fade" id="modal-stock">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="<?php echo e(route('CA_productosMP.store_stock')); ?>" class="form-horizontal" data-parsley-validate="true">
							<?php echo csrf_field(); ?> 
	...
	<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="<?php echo e(route('CA_productosMP.update')); ?>" class="form-horizontal" data-parsley-validate="true" enctype="multipart/form-data">
							<?php echo csrf_field(); ?>
	...
	<div class="modal fade" id="modal-add">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="<?php echo e(route('CA_productosMP.store')); ?>" class="form-horizontal" data-parsley-validate="true" enctype="multipart/form-data">
							<?php echo csrf_field(); ?>
...
<script>
  ...
  $(document).ready(function () {
  	...
  	function getDataProductos(){
		...
		var route = "<?php echo e(url('/cliente/materiaPrima/DTproductos')); ?>";
		var idioma_espaniol = {
			...
			success: function(data){
				...
				if (data.length > 0)
				{
					 ...
					 for (var i=0; i<data.length; i++){
						 info = [
							"<a href='#' onclick='cambioEstado(this)' id='In' data-href='/cliente/administracion/productos/" + data[i].id + "/0/estado'> <span  class='btn btn-xs btn-white m-b-3'><i class='fa fa-trash t-plus-1 text-danger fa-fw fa-sm'></i></span></a>",
							"<a href='#' onclick='editar(" + data[i].id + ")'  data-toggle='modal' data-id='" + data[i].id + "' data-target='#modal-edit'> <span  class='btn btn-xs btn-white m-b-3'><i class='fas fa-sm fa-fw text-success fa-edit'></i></a></span>",
							"<a href='#' onclick='editar_stock(" + data[i].id + ")'  data-toggle='modal' data-id='" + data[i].id +"' data-target='#modal-lista_stock'> <span  class='btn btn-xs btn-white m-b-3'><i class='fas fa-sm fa-fw text-success fa-list-alt'></i></a></span>",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jpabl\OneDrive\Escritorio\respaldo\store-sp-pro\produccion\resources\views/cliente/materiaPrima/productos/index.blade.php ENDPATH**/ ?>