...
<script>
	...
	function getDataClientes(){
		...
		var route = "<?php echo e(url('/cliente/administracion/DTclientes')); ?>";
		var idioma_espaniol = {
			...
			success: function(data){
				...
				if (data.length > 0)
				{
					...
					for (var i=0; i<data.length; i++){
						info = [
							"<a href='#' onclick='cambioEstado(this)' id='In' data-href='/cliente/administracion/clientes/" + data.id + "/0/estado'> <span  class='btn btn-xs btn-white m-b-10'><i class='fa fa-trash t-plus-1 text-success fa-fw fa-sm'></i></span></a>",
							data[i].id,
							data[i].Nombre,
							data[i].email,
							data[i].telefono,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/cst62160/sistemas/produccion/resources/views/cliente/administracion/clientes/index.blade.php ENDPATH**/ ?>