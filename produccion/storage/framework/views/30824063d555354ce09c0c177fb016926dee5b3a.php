                                    ...
                                    <div class="table-responsive">
										<table class="table table-striped">
											...
											<div class="float-left">
												...
												<a href="<?php echo e(route('CA_ventas_cotizaciones.vista_previa',$encabezado->id)); ?>" class="btn btn-sm btn-white m-b-10"><i class="fa fa-file-pdf t-plus-1 text-success fa-fw fa-lg"></i> </a>
											</div>
												...
												<?php $__currentLoopData = $contenido; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<tr>
														...
														<td class="with-btn" >
															...
															<a href="#" onclick="cambioEstado(this)" id="In" data-href="<?php echo e(route('CA_ventas_cotizaciones.estado_detalle',[ $items->id ,0])); ?>"> <span  class="btn btn-sm btn-white m-b-10"><i class="fa fa-trash t-plus-1 text-success fa-fw fa-lg"></i></span></a>
															<?php else: ?>
...
$("#productos").change(function () {
	var id = $("#productos").val();
        $.ajax({
            url: "<?php echo e(url('/cliente/ventas/cotizaciones/')); ?>/"+id+"/store_detalle",
            type: 'get',
            dataType: 'json',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/cst62160/sistemas/produccion/resources/views/cliente/ventas/cotizaciones/detalle.blade.php ENDPATH**/ ?>