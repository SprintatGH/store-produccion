												...
												<?php $__currentLoopData = $contenido; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<tr>
														...
														<td class="with-btn" >
															...
															<a href="#" onclick="cambioEstado(this)" id="In" data-href="<?php echo e(route('CA_productos_categoria.estado',[ $items->id ,0])); ?>"> <span  class="badge bg-danger">In</span></a>
															<?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/cst62160/sistemas/desarrollo/resources/views/cliente/administracion/productos/categoria/index.blade.php ENDPATH**/ ?>