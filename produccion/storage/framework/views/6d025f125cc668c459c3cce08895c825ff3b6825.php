												...
												<?php $__currentLoopData = $contenido; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<tr>
														...
														<td class="with-btn" >
															...
															<a href="#" onclick="cambioEstado(this)" id="In" data-href="<?php echo e(route('CA_ventas_cotizaciones.estado',[ $items->id ,0])); ?>"> <span  class="btn btn-sm btn-white m-b-10"><i class="fa fa-trash t-plus-1 text-success fa-fw fa-lg"></i></span></a>
															
															<a href="<?php echo e(route('CA_ventas_cotizaciones.detalle',$items->id)); ?>" ><span class="btn btn-sm btn-white m-b-10" ><i class="fa fa-address-card t-plus-1 text-success fa-fw fa-lg" ></i></span></a>
                                                            <a href="<?php echo e(route('CA_ventas_cotizaciones.vista_previa',$items->id)); ?>" ><span class="btn btn-sm btn-white m-b-10" ><i class="fa fa-eye t-plus-1 text-success fa-fw fa-lg" ></i></span></a>
                                                           <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\store-sftp-local\sistemas\desarrollo\resources\views/cliente/ventas/cotizaciones/index.blade.php ENDPATH**/ ?>