...
<?php $__env->startSection('content'); ?>
   ...
   <?php if($action == "listado"): ?> 
				...
				<ol class="breadcrumb float-xl-right">
					...
					<h1 class="page-header">Listado <small>Empresas</small></h1>
					<div class="row">
						<div class="col-xl-12">
												...
												<?php $__currentLoopData = $contenido; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<tr>
														...
														<td class="with-btn" >
															...
															<a href="#" onclick="cambioEstado(this)" id="In" data-href="<?php echo e(route('AD_Empresas.estado',[ $items->id ,0])); ?>"> <span  class="btn btn-sm btn-white m-b-10"><i class="fa fa-trash t-plus-1 text-success fa-fw fa-lg"></i></span></a>
																<?php else: ?>
															<a href="#" onclick="cambioEstado(this)" id="In" data-href="<?php echo e(route('AD_Empresas.estado',[ $items->id ,1])); ?>"> <span class="badge bg-success">Ac</span></a>
															<?php endif; ?>
														</td>
														...
														<td><?php echo e($items->razon_social); ?></td>
	...
	<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="<?php echo e(route('AD_Empresas.update')); ?>" class="form-horizontal" data-parsley-validate="true">
							<?php echo csrf_field(); ?>
	...
	<div class="modal fade" id="modal-add">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<form method="POST" action="<?php echo e(route('AD_Empresas.store')); ?>" class="form-horizontal" data-parsley-validate="true">
							<?php echo csrf_field(); ?>
							
								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="rut">Rut * :</label>
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="text" id="rut" name="rut" placeholder="Requerido" data-parsley-required="true" />
									</div>
								</div>
							    <div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="nombre">Nombre * :</label>
								...
								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="razon_social">Razon social * :</label>
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="text" id="razon_social" name="razon_social" placeholder="Requerido" data-parsley-required="true" />
									</div>
								</div>
								<div class="form-group row m-b-15">
								...
								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="contacto_nombre">Contacto Nombre * :</label>
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="text" id="contacto_nombre" name="contacto_nombre" placeholder="Requerido" data-parsley-required="true" />
									</div>
								</div>
								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="contacto_telefono">Contacto Telefono * :</label>
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="text" id="contacto_telefono" name="contacto_telefono" placeholder="Requerido" data-parsley-required="true" />
									</div>
								</div>
								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="contacto_email">Contacto Email * :</label>
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="text" id="contacto_email" name="contacto_email" placeholder="Requerido" data-parsley-required="true" />
									</div>
								</div>
								<div class="modal-footer">
									<a href="javascript:;" class="btn btn-white" data-dismiss="modal">Cancelar</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/cst62160/sistemas/produccion/resources/views/administrador/empresas/index.blade.php ENDPATH**/ ?>